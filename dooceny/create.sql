...
begin
    ...
    update wypozyczenia set id_oddzialu = id_migracji where id_oddzialu = old.id_oddzialu;
...
begin 
    ...
    odd := (select id_oddzialu from ksiazki where new.id_ksiazki = id_ksiazki);
    new.id_oddzialu := odd;
...
COPY wypozyczenia (id_studenta, id_oddzialu, id_pracownika, id_ksiazki, data_wypozyczenia, termin_oddania) FROM stdin (Delimiter',');
1,6,15,1,\N,\N
2,5,15,2,\N,\N
3,3,15,3,\N,\N
4,3,15,4,\N,\N
